...
namespace ProjectsDocumentation.BlazorWebApp.Migrations
{
    ...
    [Migration("20250530182658_AddNameColumnToEndpointTable")]
    partial class AddNameColumnToEndpointTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectsDocumentation.BlazorWebApp.Entities.EndpointRequest", b =>
                {
                    ...
                    b.HasOne("ProjectsDocumentation.BlazorWebApp.Entities.LookupValue", "RequestType")
                        .WithMany("EndpointRequests")
